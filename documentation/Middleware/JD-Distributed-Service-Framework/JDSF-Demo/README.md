...
__2、本Demo为idea项目，构建工具为maven。如果您的环境也是idea+maven，那么可以直接下载使用。否则请按照自己的工具和环境来创建项目；
...
![集群地址](./jpg/cluster_nodes.png)<br />
在配置文件(application.properties)的配置key和使用方式如下图：<br />
![配置使用](./jpg/cluster.png)<br />
