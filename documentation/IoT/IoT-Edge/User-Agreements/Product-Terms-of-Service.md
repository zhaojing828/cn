...
本服务条款是京东云网站所有者（本协议中称为“京东云”，网址：[www.jdcloud.com](http://www.jdcloud.com/) ）与您就物联网智能边缘计算服务的相关事项所订立的有效合约。您通过盖章、网络页面点击确认或以其他方式选择接受本服务条款，包括但不限于未点击确认本服务条款而事实上使用了京东云物联网智能边缘计算服务，即表示您与京东云已达成协议并同意接受本服务条款的全部约定内容。如若双方盖章文本与网络页面点击确认或以其他方式选择接受之服务条款文本，存有不一致之处，以双方盖章文本为准。
...
1.1 本条款中“服务”指：京东云向您提供www.jdcloud.com 网站上所展示的物联网智能边缘计算服务以及相关的技术及网络支持服务。
...
3.1.10 数据备份系您的义务和责任。虽然京东云物联网智能边缘计算可能会配置必要的具有日常数据备份功能的工具，但并不意味着数据备份是京东云的义务。京东云不保证完全备份用户数据，亦不对用户数据备份工作或结果承担任何责任。
...
3.2.3 若服务涉及物联网智能边缘计算的，京东云仅负责操作系统以上的部分及京东云提供的软件的运营维护，即物联网智能边缘计算服务的相关技术架构及操作系统等。操作系统之下部分 （如您在系统上安装的应用程序）由您自行负责。此外，您自行升级操作系统可能会造成宕机等不良影响，请自行把握风险并谨慎操作。
...
7.1 服务期限自您创建物联网智能边缘计算服务，并成为付费租户（指jdcloud.com上所向您展示并提供的服务）成功之日起计算。具体服务期限将根据您实际使用情况计算。
...
7.2.4 京东云可提前在www.jdcloud.com 上通告或给您发网站内通知或书面通知的方式终止本服务条款。届时京东云应将您已支付但未消费的款项退还至您的京东云账户。
