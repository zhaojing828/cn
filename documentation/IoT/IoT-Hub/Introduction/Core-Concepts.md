# 核心概念
以下是物联网中心服务（IoT Hub Service）帮助文档中使用到的概念及其解释，请参考。
...
| 物联网中心服务实例 | 物联网中心服务实例，简称“实例”，是用户购买物联网中心服务的基本单位。各个用户创建的实例时相互独立，资源隔离| 
...
| 物模型 | 设备在云端的功能描述，包括设备的设备遥测数据属性、设备状态属性、设备控制指令。物模型采用JSON格式描述。 |
...
| 规则引擎 | 对IoT Hub接收的设备数据进行过滤，并能够将处理后的数据发送到京东云其他服务，例如RDS，JCQ，ES等。 |
