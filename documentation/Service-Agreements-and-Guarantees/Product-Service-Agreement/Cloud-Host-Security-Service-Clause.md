...
3.1.3.6 不得将京东云所提供的云主机用作虚拟服务器、或用作磁盘空间出租，或用作非法代理服务器（Proxy）或垃圾邮件服务器；
...
3.1.3.8 不应大量占用,亦不得导致如程序或进程等大量占用京东云云计算资源（如云主机、网络带宽、存储空间等）所组成的平台（以下简称“云平台”）中服务器内存、 CPU或者网络带宽资源，并给京东云云平台或者京东云的其他用户的网络、服务器（包括但不限于本地及外地和国际的网络、服务器等）、产品/应用等带来严重的、不合理的负荷，影响京东云与国际互联网或者京东云与特定网络、服务器及京东云内部正常通畅的联系，或者导致京东云云平台产品与服务或者京东云的其他用户的服务器宕机、死机或者用户基于云平台的产品/应用不可访问等；
...
7.1 服务期限自您创建任一云主机服务（指[www.jdcloud.com](https://www.jdcloud.com/)上所向您展示并提供的服务）成功之日起计算，而非以您获得云主机服务的管理员身份（包括获取了管理员登录号和密码）为依据。具体服务期限将根据您实际使用情况计算。云主机服务创建成功后，您需进行网站开通前准备的（如办理网站经营许可证/网站备案手续等），准备期间包含在服务期限内。
