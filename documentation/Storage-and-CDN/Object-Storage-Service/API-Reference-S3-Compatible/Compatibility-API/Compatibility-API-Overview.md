...
|GET Bucket notification|返回设置在Bucket上的回调通知配置|兼容[GET Bucket notification](./Operations-On-Bucket/Operations-On-Bucket/GET-Bucket-Notification-2.md)|[GET Bucket notification](https://docs.aws.amazon.com/zh_cn/AmazonS3/latest/API/RESTBucketGETnotification.html)|
