...
监控指标 | 定义 | 单位 |说明
---|---|---|---
公网入包量 | 公网IP平均每秒流入数据包数量 |pps |每秒由公网经该公网IP流入用户云资源数据包数量
公网出包量 | 公网IP平均每秒流出数据包数量 |pps |每秒由用户云资源经该公网IP发往公网数据包数量
公网入速率 | 公网IP平均每秒入流量 |bps|每秒由公网经该公网IP流入用户云资源数据流平均速率
公网出速率 | 公网IP平均每秒出流量 |bps |每秒由用户云资源经该公网IP发往公网数据流平均速率
